            ...
            <tbody>
                @foreach ($album->songs as $index => $song)
                    <tr id="song_{{ $song->id }}">
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#addSongToPlaylistModal">
                                Añadir a Playlist
                            </button>
                            
                            <div class="modal fade" id="addSongToPlaylistModal" tabindex="-1"
                                aria-labelledby="addSongToPlaylistModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content glass-morphism">
                                        <div class="modal-header">
