...
<table class="text-white w-100 songsList">
    ...
    <tbody>
        ...
        <tr id="song_{{ $song->id }}">
            ...
            <td>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSongToPlaylistModal">
                    Añadir a Playlist
                </button>

                <div class="modal fade" id="addSongToPlaylistModal" tabindex="-1" aria-labelledby="addSongToPlaylistModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content glass-morphism">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addSongToPlaylistModalLabel">Añadir Canción a la
                                    Playlist</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="text-white" method="POST" action="{{ route('playlist.addSong') }}">
                                    @csrf
